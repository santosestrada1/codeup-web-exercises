(function() {
    ...
    // var person = {firstName: "Santos" , lastName: "Estrada"}

    // or

    // var person = {};
    // person.firstName= "Santos"
    //     person.lastName="Estrada"
    ...
    shoppers.forEach(function(shopper) {
        if(shopper.amount <=200){
            console.log(shopper.name + ":" + " Amount Owed:" + "$" + shopper.amount)
            console.log("NO DISCOUNT")
        }
        else if (shopper.amount > 200){
            console.log(shopper.name + ":" + " Original Amount Owed:" + "$" + shopper.amount)
            console.log("You Saved $" + (shopper.amount* .12))
            console.log(shopper.name + ":"+ "True Amount owed: " + "$" +(shopper.amount - (shopper.amount*.12)))
        }
