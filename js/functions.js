 ...
 */
let helloMessage = sayHello ("Santos");
...
let totalBill = parseFloat(prompt("What percentage would you like to tip?"));
let tipPercentage = parseFloat (prompt("What is your bill total?"));
